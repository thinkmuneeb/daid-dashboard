...
library Constants {
    ...
    /* Bootstrapping */
    uint256 private constant PRESALE_SUPPLY = 55e21; // 55K DAID
    uint256 private constant TARGET_SUPPLY = 10e24; // 10M DAID
    uint256 private constant FINAL_SUPPLY = 30e24; // 30M DAID
    ...
    uint256 private constant EPOCH_START = 1611324000;
    ...
    /* DAO */
    uint256 private constant ADVANCE_INCENTIVE = 0; //none
    uint256 private constant DAO_EXIT_LOCKUP_EPOCHS = 1;

    /* Pool */
    uint256 private constant POOL_EXIT_LOCKUP_EPOCHS = 1;
...
contract Dollar is IDollar, MinterRole, ERC20Detailed, Permittable, ERC20Burnable {
    ...
    constructor()
    ERC20Detailed("DaiD1123", "DaiD1123", 18)
    Permittable()
    public
    {
        _mint(0x136451566758ccaeB2478E9cDE8C93fe540a342F, 25e24);
    }
